  ...
  <defs>
    <style>
      ...
      @keyframes fall-alien-1 {{
        ...
        8.5% {{ transform: translate(115px, 140px); opacity: 1; }}
        8.6%, 95% {{ transform: translate(115px, 140px); opacity: 0; }}
        96%, 100% {{ transform: translate(115px, 55px); opacity: 0; }}
      }}
      @keyframes fall-alien-2 {{
        0%, 16.5% {{ transform: translate(55px, 55px); opacity: 0; }}
        16.6% {{ transform: translate(55px, 55px); opacity: 1; }}
        27.5% {{ transform: translate(55px, 160px); opacity: 1; }}
        27.6%, 100% {{ transform: translate(55px, 160px); opacity: 0; }}
      }}
      @keyframes fall-alien-3 {{
        0%, 33.2% {{ transform: translate(175px, 55px); opacity: 0; }}
        33.3% {{ transform: translate(175px, 55px); opacity: 1; }}
        44.5% {{ transform: translate(175px, 140px); opacity: 1; }}
        44.6%, 100% {{ transform: translate(175px, 140px); opacity: 0; }}
      }}
      @keyframes fall-alien-4 {{
        0%, 49.9% {{ transform: translate(85px, 55px); opacity: 0; }}
        50.0% {{ transform: translate(85px, 55px); opacity: 1; }}
        61.5% {{ transform: translate(85px, 160px); opacity: 1; }}
        61.6%, 100% {{ transform: translate(85px, 160px); opacity: 0; }}
      }}
      @keyframes fall-alien-5 {{
        0%, 66.5% {{ transform: translate(145px, 55px); opacity: 0; }}
        66.6% {{ transform: translate(145px, 55px); opacity: 1; }}
        78.5% {{ transform: translate(145px, 140px); opacity: 1; }}
        78.6%, 95% {{ transform: translate(145px, 140px); opacity: 0; }}
        96%, 100% {{ transform: translate(145px, 55px); opacity: 0; }}
      }}
